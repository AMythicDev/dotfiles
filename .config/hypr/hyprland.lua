...
hl.on("hyprland.start", function()
  ...
  hl.exec_cmd("sleep 1 && bluetooth-autoconne")
  hl.exec_cmd("udiskie")
end)
...
hl.bind(mainMod .. " + M",
  hl.dsp.exec_cmd("quickshell -c leave"))
...
hl.bind("Print", hl.dsp.exec_cmd("bash -c \"grim '$HOME/Pictures/Screenshots/Screenshot_$(date +'%Y%m%d_%H%M%S.png')'\""))

hl.bind(mainMod .. "+ SHIFT + S",
  hl.dsp.exec_cmd("bash -c \"grim -g '$(slurp)' '$HOME/Pictures/Screenshots/Screenshot_$(date +'%Y%m%d_%H%M%S.png')'\""))
...
hl.bind(mainMod .. " + SHIFT + P", hl.dsp.exec_cmd("playerctl previous"), { locked = true })
